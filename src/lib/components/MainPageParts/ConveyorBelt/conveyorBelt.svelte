...
<div
  class="relative w-screen overflow-y-hidden overflow-x-hidden bg-[#754f4f] -mt-1"
>
  <div
  ...
  >
    ...
    <div class="absolute top-0 left-0 min-w-[1000px] w-full h-full">
      <img
        alt="foreground"
      ...
      <div
        class="food scroll absolute top-[5.8%] z-50 overflow-hidden h-full"
