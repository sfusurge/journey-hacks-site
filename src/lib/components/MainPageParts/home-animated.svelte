...
<div class="max-w-screen overflow-x-hidden">
    ...
    <div class="relative bg-[#8F6455] aspect-[0.67/1] md:aspect-[1.41/1]">
        <div class="title absolute mx-auto w-[100vw] sm:mx-0 sm:right-8 -top-16 md:-top-4 xl:top-16">
            <span class="font-coiny mx-auto sm:mx-0 text-xl lg:text-3xl">FEB 14, 2025</span>
            <h1 class="title1 mx-auto sm:mx-0 font-coiny text-5xl">JOURNEY</h1>
            <h1 class="-mt-2 mx-auto sm:mx-0 title2">HACKS</h1>
        </div>

        {#if width < 768}
            <img src="/home-animated/mobile-bg.webp" alt="background" class="w-full h-auto block md:hidden" />
            ...
            />
        {:else}
            <img src="/home-animated/background.webp" alt="background" class="w-full h-auto hidden md:block" />
            <img
